  ...
  const experiences = [
    {
      ...
      strengths: ["Redux Expert", "GraphQL", "TDD Champion", "React 18", "UI/UX Design"],
    ...
    },
    {
      ...
      strengths: ["CI/CD Pipeline Expert", "Angular Architecture", "Team Collaboration", "Performance Optimization"],
      technologies: "Angular 8, React, Redux, HTML5, CSS, JSON, Typescript, JavaScript, NodeJS, GIT, AWS CLI, Terraform"
    },
    {
      company: "Yes Bank",
      location: "India",
      ...
      strengths: ["Angular Expert", "Team Collaboration", "Performance Tuning", "Mentorship"],
      technologies: "Angular6, HTML5, CSS, Typescript, JavaScript, NodeJS, Eslint, JSON, REST, SASS"
    }
  ];
  ...
  return (
    <section id="experience" className="py-20 bg-gradient-to-b from-white to-blue-50">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="section-title mx-auto w-fit">Professional Experience</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mt-4">
            Track record of delivering high-performance web applications and leading technical innovations
          </p>
        </motion.div>
              ...
              <Card className="glass-card border-l-4 border-l-portfolio-blue hover:shadow-xl transform-gpu transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.strengths.map((strength, i) => (
                        <motion.div
                          ...
                          viewport={{ once: true }}
                        >
                          <Badge variant="outline" className="bg-white border-portfolio-blue text-portfolio-blue">
                            {strength}
                          </Badge>
                        </motion.div>
                      ))}
                  ...
                  >
                    ...
                    <p className="text-gray-700 text-sm bg-gray-50 p-2 rounded border border-gray-100 shadow-inner">{exp.technologies}</p>
                  </motion.div>
                </CardContent>
              </Card>
            </motion.div>
